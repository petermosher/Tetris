...
public abstract class Piece implements Cloneable {
  ...
  /*@ public model int current_rotation;
      public invariant 0 <= current_rotation &&
                       current_rotation < rotations.size();
      private represents current_rotation = my_current_rotation; @*/
  ...
  /*@ public model non_null Color color;
      public constraint \old(color) == color;
      private represents color = my_color; */
  ...
  /*@ public model non_null List rotations;
      public constraint \old(rotations).equals(rotations);
      public invariant
        (\forall int i; 0 <= i && i < rotations.size();
         rotations.get(i) != null);
      public invariant rotations.elementType == \type(Rotation);
      private represents rotations = my_rotations;
      private invariant
        (\forall int i; 0 <= i && i < my_rotations.size();
         my_rotations.get(i) != null);
      private invariant my_rotations.elementType == \type(Rotation); @*/
  ...
  /*@ public model non_null Point origin;
      private represents origin = my_origin; */

  /* the current set of blocks */
  /*@ public model non_null Point[] blocks;
      public represents
        blocks = ((Rotation) rotations.get(current_rotation)).blocks; @*/
  ...
  public Piece(final /*@ non_null @*/ Color the_color,
    ...
    /*@ assume
        temp != null &&
        (temp.size() == 1 || temp.size() == 2 || temp.size() == 4) &&
        temp.elementType == \type(Rotation); @*/
    my_rotations = temp;
  ...
  public /*@ pure non_null */ Point[] blocks() {
    //@ assume \typeof(rotations().get(my_current_rotation)) == \type(Rotation);
  ...
  /*@ ensures \result.current_rotation ==
                (current_rotation + 1) % rotations.size(); @*/
  /**
  ...
  /*@ ensures \result.current_rotation ==
                ...
                rotations.size(); @*/ // java's % operator isn't really "mod"
  /**
  ...
  /*@ ensures
      ...
      the_other_piece.origin.equals(origin) &&
   ...
   */
  public /*@ pure */ boolean equalsExceptRotation
  (final /*@ non_null */ Piece the_other_piece) {
    boolean result =
      the_other_piece.color().equals(color()) &&
   ...
   */
  public /*@ pure */ boolean equalsExceptOrigin
  (final /*@ non_null */ Piece the_other_piece) {
    boolean result =
      the_other_piece.color().equals(color()) &&
  ...
  /*@ also public behavior
      ...
      ensures \result <==>
              ((Piece) the_other).color.equals(color) &&
              ((Piece) the_other).origin.equals(origin) &&
              ((Piece) the_other).current_rotation == current_rotation &&
              ((Piece) the_other).rotations.size() == rotations.size() &&
              (\forall int i; 0 <= i && i < rotations.size();
               ((Piece) the_other).rotations.get(i).equals
                                                      (rotations.get(i))); @*/
  /*@ also public behavior
      requires the_other == null || \typeof(the_other) != \typeof(this);
      ensures !\result; @*/
  ...
  public /*@ pure */ boolean equals(final /*@ nullable @*/ Object the_other) {
    ...
    if (!result && the_other != null && the_other.getClass() == getClass()) {
      ...
      result =
        result && (other_piece.my_current_rotation == my_current_rotation);
      for (int i = 0; result && i < rotations().size(); i++) {
        result = result &&
